...
namespace Pharaonic\Laravel\Modulator\Packages\Translatable\Commands;
...
class TranslatableMake extends Command
{
    ...
    private function generateMainModel()
    {
        ...
        $content = str_replace('{{ class }}', $this->name, file_get_contents(__DIR__ . '/../stubs/model.translatable.stub'));
    ...
    private function generateTranslatableModel()
    {
        ...
        $content = str_replace('{{ class }}', $this->name, file_get_contents(__DIR__ . '/../stubs/model.translatabled.stub'));
        $content = str_replace('{{ namespace }}', $this->getNamespace('Models'), $content);
        $content = str_replace('{{ table }}', $this->table, $content);
